          ...
          util.each(
            ...
            function (x, data) {
              option = new Option(
                ...
                data.value,
                false,
                data.hasOwnProperty('selected') && data.selected === true
              )
...
var navigate = function (e) {
  ...
  if (!direction) {
    ...
    if (this.navIndex === 0) {
      ...
      this.tree.scrollTop =
        this.tree.scrollTop + (r.top + r.height - (this.optsRect.top + this.optsRect.height))
    }
...
Selectr.prototype.render = function (config) {
  ...
  this.customOption =
    this.config.hasOwnProperty('renderOption') && typeof this.config.renderOption === 'function'
  this.customSelected =
    this.config.hasOwnProperty('renderSelection') &&
    typeof this.config.renderSelection === 'function'
