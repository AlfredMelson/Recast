/* Implements ipv4, ipv6 and hostname format validations as per https://tools.ietf.org/html/draft-fge-json-schema-validation-00#section-7.3.4 https://github.com/json-editor/json-editor/blob/master/src/validators/ip-validator.js*/
